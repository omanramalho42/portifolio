import {
  ...
  const Work = () => (
    <Layout title="portifolio">
      <Container>
        <Title>
          Modern Portifolio <Badge>2022</Badge>
        </Title>
        <P>
          Site Moderno usando React Js, tailwind css, e
          outras tecnologias
        </P>
        <List ml={4} my={4}>
          <ListItem>
            <Meta>Repository</Meta>
            <Link href="https://www.github.com/omanramalho42/portifoliobussiness">
              www.github.com/omanramalho42/portifolio <ExternalLinkIcon mx="2px" />
            </Link>
            <Meta>Platform</Meta>
        ...
        <UnorderedList my={4}>
          <ListItem>
            <Link href="https://www.github.com/omanramalho42/portifoliobussinesss">
